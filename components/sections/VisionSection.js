...
//         <div
//             className="absolute inset-0 bg-[url('/images/image.jpeg')] bg-cover bg-center brightness-[0.4] scale-105 animate-[floatImage_12s_ease-in-out_infinite]"
...
export default function VisionSection() {
  ...
  return (
    <SectionWrapper className="relative bg-black text-white overflow-hidden">
      ...
      {/* Background Layers */}
      <div className="absolute inset-0 bg-[url('/images/image.jpeg')] bg-cover bg-center brightness-[0.4] scale-105 animate-[floatImage_12s_ease-in-out_infinite]" style={{ backgroundAttachment: 'fixed' }} />
      <div className="absolute inset-0 z-10 bg-black/50 animate-[fadeOverlay_10s_ease-in-out_infinite]" />
      <div className="absolute inset-0 bg-[url('/images/547.png')] opacity-5 mix-blend-overlay pointer-events-none" />
      <div ref={gradientRef} className="absolute inset-0 bg-gradient-to-br from-[#D4AF37]/30 via-black to-blue-900/30 opacity-20" />
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        {["🔗", "🌐", "🏢", "🌿"].map((icon, i) => (
          <div
            key={i}
      ...
      <div ref={sectionRef} className="relative z-20 flex flex-col justify-center items-start text-left max-w-4xl mx-auto min-h-[60vh]">
        ...
        <div ref={el => contentRefs.current[0] = el} className="mb-8 md:mb-12 text-left">
          <h2 className="text-3xl sm:text-4xl md:text-6xl font-bold mb-4 leading-tight">
            <span>Foundations </span>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D4AF37] to-[#e5c96f]">for Tomorrow</span>
          </h2>
          <p className="text-sm md:text-base text-gray-400 max-w-2xl leading-relaxed">
            At Noor Construction, we craft not just buildings but <span className="text-white font-semibold">timeless landmarks</span>, blending <span className="text-[#D4AF37] font-medium">precision</span>, <span className="text-green-400">sustainability</span>, and <span className="text-blue-400">innovation</span>.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
          {[
            ...
            <div
              key={i}
              ref={el => contentRefs.current[i + 1] = el}
              className="group bg-white/5 border border-white/10 backdrop-blur-sm p-5 rounded-2xl hover:border-[#D4AF37]/40 hover:shadow-lg hover:scale-[1.02] transition-all duration-500"
            >
              <div className="flex items-start gap-4">
                <div className="text-3xl md:text-4xl text-[#D4AF37]">{item.icon}</div>
                <div>
