  ...
  return (
    <>
      ...
      <section ref={sectionRef} className="relative w-full min-h-screen overflow-hidden bg-black text-white">
        ...
        <div className="relative z-10 w-full max-w-6xl mx-auto flex flex-col justify-center px-8 sm:px-12 md:px-16 lg:px-24 py-24 lg:py-40">
          ...
          <p ref={descRef} className="text-lg md:text-xl text-gray-400 max-w-3xl mb-12">
